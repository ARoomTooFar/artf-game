...
_BumpStrength("_BumpStrength", Range(1,8) ) = 1
...
float4 Sampled2D0=tex2D(_DecalTex,IN.uv_DecalTex.xy);
float4 Multiply0=Sampled2D1 * Sampled2D0;
float4 Add1=_Color + _Color;
float4 Multiply2=Multiply0 * Add1;
